...
contract Raffle is Ownable {
    ...
    */
    function start_new_raffle(address _NFTcontract, 
                               ...
                               uint256 _ticket_amount) external raffleCurrentlyStarting {
    ...
    */
    function enter(uint256 _raffleId, uint256 _ticket_amount) external payable {
    ...
    */
    function end_raffle(uint256 _raffleId) external {
    ...
    */
    function raffle_result(uint256 requestId, uint256 random) public {
    ...
    */
    function get_current_raffle_num() private view returns(uint256){
        uint256 counter = 0;
    ...
    */
    function get_current_raffles() external view returns(raffle[] memory) {
    ...
    */
    function setMinFeeBalance(uint256 _min_fee_balance) external onlyOwner {
